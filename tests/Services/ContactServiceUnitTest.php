...
class ContactServiceUnitTest extends PHPUnit_Framework_TestCase{
	...
	public function testGetContacts()
	{
		...
		$contacts = $contact_service->getContacts('access_token', 0, 2);
		$contact = $contacts[1];
	...
	/**
	 * Test getting an individual contact
	 */
	public function testGetContact()
	{
		...
		$this->assertEquals("Engineering", $contact->department_name);
		...
		$this->assertEquals(false, $contact->source_is_url);
	...
	public function testGetContactByEmail()
	{
		...
		$contact_service = new ContactService($rest_client);
		$contacts = $contact_service->getContactByEmail('access_token', 'john+smith@gmail.com');
		$contact = $contacts[0];
