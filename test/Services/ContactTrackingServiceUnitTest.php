...
class ContactTrackingServiceUnitTest extends PHPUnit_Framework_TestCase{
    ...
    public function testGetBounces()
    {
        ...
        $tracking_activity = $svc->getBounces('access_token', 71, array('limit' => 2));
    ...
    public function testGetClicks()
    {
        ...
        $tracking_activity = $svc->getClicks('access_token', 71, array('limit' => 2));
    ...
    public function testGetForwards()
    {
        ...
        $tracking_activity = $svc->getForwards('access_token', 71, array('limit' => 2));
    ...
    public function testGetSends()
    {
        ...
        $tracking_activity = $svc->getSends('access_token', 2);
    ...
    public function testGetOpens()
    {
        ...
        $tracking_activity = $svc->getOpens('access_token', 71, array('limit' => 2));
    ...
    public function testGetSummary()
    {
        ...
        $summary = $svc->getSummary('access_token', 71);
